...
(function($) {
    ...
    function init(opts) {
        ...
        var activationDelay = function() {
			...
			var $submenu = $(activeRow).find('ul.sub');
			var offset = $submenu.offset(),
				...
				upperRight = {
					x: offset.left + $submenu.outerWidth(),
					y: upperLeft.y
				},
				lowerLeft = {
					x: offset.left,
					y: offset.top + $submenu.outerHeight() + options.tolerance
				},
				lowerRight = {
					x: offset.left + $submenu.outerWidth(),
					y: lowerLeft.y
			...
			var decreasingCorner = upperLeft,
